        ...
        <div class="collapse navbar-collapse" id="mainNavbar">
            <ul class="navbar-nav me-auto">
                <?php if ($_SESSION['role'] === 'admin'): ?>
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['SCRIPT_NAME']) == 'list_users.php' ? 'active' : '' ?>" href="<?= $base_url ?>users/list_users.php">
                ...
                <?php if ($_SESSION['role'] === 'procurement'): ?>
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['SCRIPT_NAME']) == 'list_suppliers.php' ? 'active' : '' ?>" href="<?= $base_url ?>suppliers/list_suppliers.php">
                            <i class="bi bi-truck me-1"></i> Suppliers
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['SCRIPT_NAME']) == 'list_procurements.php' ? 'active' : '' ?>" href="<?= $base_url ?>procurements/list_procurements.php">
                ...
                <?php if ($_SESSION['role'] === 'pharmacist'): ?>
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['SCRIPT_NAME']) == 'list_stock.php' ? 'active' : '' ?>" href="<?= $base_url ?>stock/list_stock.php">
                            <i class="bi bi-capsule me-1"></i> Stock
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['SCRIPT_NAME']) == 'list_distributions.php' ? 'active' : '' ?>" href="<?= $base_url ?>distributions/list_distributions.php">
                            <i class="bi bi-send me-1"></i> Distributions
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['SCRIPT_NAME']) == 'stock_report.php' ? 'active' : '' ?>" href="<?= $base_url ?>reports/stock_report.php">
            ...
            <div class="dropdown">
                <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <strong><?= htmlspecialchars($_SESSION['user_name'] ?? $_SESSION['role']) ?></strong>
                </a>
